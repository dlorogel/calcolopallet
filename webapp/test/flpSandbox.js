		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calcolo Pallet",
									"targetURL": "#itorogelzcalcolopallet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelzcalcolopallet-display": {
								"semanticObject": "itorogelzcalcolopallet",
								"action": "display",
								"description": "Calcolo Pallet",
								"title": "Calcolo Pallet",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.zcalcolopallet",
									"url": sap.ui.require.toUrl("it/orogel/zcalcolopallet")
								}
							}
						}
					}
